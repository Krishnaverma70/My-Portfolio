    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center items-center h-full w-full">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full px-4">
        <motion.div style={{ opacity: opacity1, y: y1 }}>
          ...
          <p className="mt-4 text-xl md:text-2xl text-zinc-400 font-light tracking-widest uppercase">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8">
            {[
              ...
              <motion.div
                ...
                className={`relative w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-zinc-900/80 backdrop-blur-md border border-zinc-800 p-4 flex items-center justify-center transform hover:scale-115 transition-all duration-300 drop-shadow-2xl ${tool.shadow}`}
                style={{
      ...
      <div className="absolute top-1/2 left-[10%] md:left-[20%] -translate-y-1/2">
        <motion.div style={{ opacity: opacity2, x: x2 }}>
          <h2 className="text-5xl md:text-7xl font-bold text-white leading-none tracking-tight drop-shadow-xl max-w-lg">
            I build <br/>
      ...
      <div className="absolute top-1/2 right-[10%] md:right-[20%] -translate-y-1/2 text-right">
        <motion.div style={{ opacity: opacity3, x: x3 }}>
          <h2 className="text-5xl md:text-7xl font-bold text-white leading-none tracking-tight drop-shadow-xl max-w-lg">
            Bridging <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-l from-yellow-400 via-amber-400 to-orange-550">
              design & engineering.
            </span>
          </h2>
        </motion.div>
